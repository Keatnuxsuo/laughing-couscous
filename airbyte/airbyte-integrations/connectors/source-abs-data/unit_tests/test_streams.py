...
import pytest
from source_abs_data.source import AbsDataStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AbsDataStream, "path", "v0/example_endpoint")
    mocker.patch.object(AbsDataStream, "primary_key", "test_primary_key")
    mocker.patch.object(AbsDataStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = AbsDataStream()
