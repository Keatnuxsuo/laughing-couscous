...
import pytest
from source_domain_api.source import DomainApiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DomainApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(DomainApiStream, "primary_key", "test_primary_key")
    mocker.patch.object(DomainApiStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DomainApiStream()
